...
class InsuranceControllerTest {
    ...
    void setup() {
        ...
        insurance = Insurance.builder()
                ...
                .insurancePrice(10)
                .discount(0)
                .insuranceStartDate(Date.from(LocalDate.parse("2025-01-01").atStartOfDay().toInstant(ZoneOffset.UTC)))
                .insuranceEndDate(Date.from(LocalDate.parse("2025-12-31").atStartOfDay().toInstant(ZoneOffset.UTC)))
    ...
    void testGetInsurances() throws Exception {
        ...
        response.andDo(print()).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].insurances[0].insuranceNumber").value(insurance.getInsuranceNumber()))
                .andExpect(jsonPath("$[0].insurances[0].insuranceType").value(insurance.getInsuranceType()))
                .andExpect(jsonPath("$[0].insurances[0].insurancePrice").value(insurance.getInsurancePrice()))
                .andExpect(jsonPath("$[0].insurances[0].discount").value(insurance.getDiscount()))
                .andExpect(jsonPath("$[0].insurances[0].insuranceStartDate").value("2025-01-01T00:00:00.000+00:00"))
                .andExpect(jsonPath("$[0].insurances[0].insuranceEndDate").value("2025-12-31T00:00:00.000+00:00"))
                .andExpect(jsonPath("$[0].insurances[0].insuranceStatus").value(insurance.getInsuranceStatus()));
    }
    ...
    void testGetInsuranceWithVehicleInfo() throws Exception {
        ...
        response.andDo(print()).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].insurances[0].insuranceEndDate").value("2025-12-31T00:00:00.000+00:00"))
                .andExpect(jsonPath("$[0].insurances[0].insuranceStatus").value(insurance.getInsuranceStatus()))
                .andExpect(jsonPath("$[0].vehicles[0].registrationNumber").value(vehicle.getRegistrationNumber()))
                ...
                .andExpect(jsonPath("$[0].vehicles[0].ownerPersonalNumber").value(vehicle.getOwnerPersonalNumber()))
    ...
    void testGetInsuranceWithPromotionBlackFriday() throws Exception {
        ...
        response.andDo(print()).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].insurances[0].insuranceNumber").value(insurance.getInsuranceNumber()))
                .andExpect(jsonPath("$[0].insurances[0].insuranceStatus").value(insurance.getInsuranceStatus()))
                .andExpect(jsonPath("$[0].promotion").value("Black Friday - 10% off, valid until 2025-12-31"));
    }
}